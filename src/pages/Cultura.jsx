...
const Cultura = () => {
  ...
  const loadArticles = () => {
    ...
    const cultureArticles = allArticles.filter(article => article.page === 'cultura');
    setFeaturedArticles(cultureArticles.slice(0, 6));
  };
    ...
    <div className="pt-24 pb-20 px-4 md:px-8 max-w-[1280px] mx-auto">
      <div className="mb-12 border-l-4 border-secondary pl-6">
        ...
        <p className="font-body-lg text-body-lg text-gray-600 max-w-2xl">
          Arte, música, literatura e tradições que movem a alma amazônica.
        </p>
      </div>
