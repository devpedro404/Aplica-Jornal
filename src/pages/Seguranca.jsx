...
const Seguranca = () => {
  ...
  const loadArticles = () => {
    ...
    const securityArticles = allArticles.filter(article => article.page === 'seguranca');
    setFeaturedArticles(securityArticles.slice(0, 6));
  };
    ...
    <div className="pt-24 pb-20 px-4 md:px-8 max-w-[1280px] mx-auto">
      <div className="mb-12 border-l-4 border-secondary pl-6">
        ...
        <p className="font-body-lg text-body-lg text-gray-600 max-w-2xl">
          Acompanhamento das operações e políticas de segurança na região amazônica.
        </p>
      </div>
